...
const features = [
  {
    ...
    description:
      "Our system learns your gaps and serves questions at exactly the right difficulty — no wasted time on topics you already know.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Every question comes with a full step-by-step solution. Understand the method, not just the answer.",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
  ...
  },
  {
    ...
    description:
      "Content mapped to AQA, Edexcel, and OCR. Foundation and Higher tiers. Nothing off-spec, nothing missing.",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
  ...
  },
  {
    ...
    description:
      "Topic mastery scores, predicted grade, and streak tracking keep students motivated and parents informed.",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 antialiased">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-gray-100">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-100 px-4 py-4 flex flex-col gap-4 text-sm">
            ...
            <a href="/signup" className="font-semibold bg-gray-900 text-white px-4 py-2 rounded-lg text-center">
              Start free →
            </a>
          </div>
        )}
        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 pt-16 pb-20 md:pt-24 md:pb-28">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-gray-500 leading-relaxed mb-8 max-w-xl">
              Adaptive practice questions, full worked solutions, and real-time progress tracking — aligned to every major GCSE exam board.
            </p>

            <div className="flex flex-col sm:flex-row gap-3 mb-10">
              <a
                href="/signup"
                className="inline-flex items-center justify-center gap-2 bg-gray-900 text-white font-semibold px-6 py-3 rounded-lg hover:bg-gray-700 transition-colors text-sm"
              >
                Start for free
              ...
              <a
                href="#features"
                className="inline-flex items-center justify-center gap-2 border border-gray-200 text-gray-700 font-medium px-6 py-3 rounded-lg hover:bg-gray-50 transition-colors text-sm"
              >
                See how it works
              </a>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="md:flex md:items-end md:justify-between mb-10">
              <div>
                ...
                <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
                  Every GCSE topic covered.
                </h2>
              </div>
              <a
                href="/topics"
                className="hidden md:inline-flex items-center gap-1 text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors"
              >
                View all topics →
              </a>
            </div>
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 bg-blue-50 text-blue-800 rounded-lg flex items-center justify-center font-bold text-sm">
                        {t.emoji}
                      </div>
                      <div>
                    ...
                    <span className="text-xs font-semibold text-gray-400 group-hover:text-blue-700 transition-colors">
                      {t.mastery}%
                    </span>
                  </div>
            ...
            <div className="mt-6 text-center md:hidden">
              <a href="/topics" className="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors">
                View all topics →
              </a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-600">
                {[
                  "Daily streaks and XP rewards",
                  "Live predicted grade (Foundation / Higher)",
                  "Topic mastery scores per session",
                  "Leaderboard among friends or class",
                  "Weekly progress emails for parents",
                ].map((item) => (
                  <li key={item} className="flex items-start gap-2.5">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-blue-500 mt-0.5 shrink-0">
                  ...
                  <div key={d} className="flex flex-col items-center gap-1">
                    <div
                      className={`w-5 h-5 rounded-full flex items-center justify-center text-xs ${
                        i < 5 ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-300"
                      }`}
                    >
                      {i < 5 ? "✓" : ""}
                    </div>
            ...
            <div>
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-blue-500 hover:bg-blue-300 text-gray-900 font-bold py-3 rounded-lg text-sm transition-colors"
                  >
                    Get started free →
                  </button>
                  <p className="text-xs text-gray-500 text-center">
                    No spam. Free 14-day trial. Cancel any time.
                  </p>
                </form>
              )}
            </div>
